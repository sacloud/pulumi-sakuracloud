...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    public sealed class GetCertificateAuthorityFilterArgs : Pulumi.InvokeArgs
    {
        [Input("conditions")]
        private List<Inputs.GetCertificateAuthorityFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetCertificateAuthorityFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetCertificateAuthorityFilterConditionArgs>());
        ...
        public GetCertificateAuthorityFilterArgs()
        {
        }
    }
}

...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetIconFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetIconFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetIconFilterConditionArgs>());

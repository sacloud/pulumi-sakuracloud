...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    public sealed class GetEnhancedDBFilterArgs : Pulumi.InvokeArgs
    {
        [Input("conditions")]
        private List<Inputs.GetEnhancedDBFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetEnhancedDBFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetEnhancedDBFilterConditionArgs>());
        ...
        public GetEnhancedDBFilterArgs()
        {
        }
    }
}

...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetPrivateHostFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetPrivateHostFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetPrivateHostFilterConditionArgs>());

...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    public sealed class ProxyLBBindPortGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ProxyLBBindPortResponseHeaderGetArgs>? _responseHeaders;

        /// <summary>
        /// One or more `response_header` blocks as defined below.
        /// </summary>
        public InputList<Inputs.ProxyLBBindPortResponseHeaderGetArgs> ResponseHeaders
        {
            get => _responseHeaders ?? (_responseHeaders = new InputList<Inputs.ProxyLBBindPortResponseHeaderGetArgs>());

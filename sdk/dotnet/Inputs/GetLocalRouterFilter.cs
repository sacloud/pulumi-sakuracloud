...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetLocalRouterFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetLocalRouterFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetLocalRouterFilterConditionArgs>());

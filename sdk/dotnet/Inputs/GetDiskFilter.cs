...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetDiskFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetDiskFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetDiskFilterConditionArgs>());

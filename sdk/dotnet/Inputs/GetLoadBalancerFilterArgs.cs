...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetLoadBalancerFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetLoadBalancerFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetLoadBalancerFilterConditionArgs>());

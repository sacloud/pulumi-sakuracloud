...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetGSLBFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetGSLBFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetGSLBFilterConditionArgs>());

...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetContainerRegistryFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetContainerRegistryFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetContainerRegistryFilterConditionArgs>());

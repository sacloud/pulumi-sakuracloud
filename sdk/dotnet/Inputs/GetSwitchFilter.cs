...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetSwitchFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetSwitchFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetSwitchFilterConditionArgs>());

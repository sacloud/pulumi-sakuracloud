...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetDatabaseFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetDatabaseFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetDatabaseFilterConditionArgs>());

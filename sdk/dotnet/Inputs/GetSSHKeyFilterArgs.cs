...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetSSHKeyFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetSSHKeyFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetSSHKeyFilterConditionArgs>());

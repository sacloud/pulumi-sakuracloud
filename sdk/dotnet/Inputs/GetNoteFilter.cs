...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetNoteFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetNoteFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetNoteFilterConditionArgs>());

...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetServerFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetServerFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetServerFilterConditionArgs>());

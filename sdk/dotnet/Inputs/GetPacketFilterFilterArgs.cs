...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetPacketFilterFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetPacketFilterFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetPacketFilterFilterConditionArgs>());

...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetArchiveFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetArchiveFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetArchiveFilterConditionArgs>());

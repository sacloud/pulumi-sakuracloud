...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    public sealed class GetESMEFilterArgs : Pulumi.InvokeArgs
    {
        [Input("conditions")]
        private List<Inputs.GetESMEFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetESMEFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetESMEFilterConditionArgs>());

...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetDNSFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetDNSFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetDNSFilterConditionArgs>());

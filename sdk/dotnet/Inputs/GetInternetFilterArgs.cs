...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetInternetFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetInternetFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetInternetFilterConditionArgs>());

...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    public sealed class CertificateAuthorityServerArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.CertificateAuthorityServerSubjectArgs> Subject { get; set; } = null!;
        ...
        public CertificateAuthorityServerArgs()
        {
        }
    }
}

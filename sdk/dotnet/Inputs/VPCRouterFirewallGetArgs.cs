...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    public sealed class VPCRouterFirewallGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.VPCRouterFirewallExpressionGetArgs>? _expressions;

        /// <summary>
        /// One or more `expression` blocks as defined below.
        /// </summary>
        public InputList<Inputs.VPCRouterFirewallExpressionGetArgs> Expressions
        {
            get => _expressions ?? (_expressions = new InputList<Inputs.VPCRouterFirewallExpressionGetArgs>());
        ...
        public VPCRouterFirewallGetArgs()
        {
        }
    }
}

...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetNFSFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetNFSFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetNFSFilterConditionArgs>());

...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    public sealed class ServerDiskEditParameterArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("notes")]
        private InputList<Inputs.ServerDiskEditParameterNoteArgs>? _notes;

        /// <summary>
        /// A list of the `note` block as defined below.
        /// </summary>
        public InputList<Inputs.ServerDiskEditParameterNoteArgs> Notes
        {
            get => _notes ?? (_notes = new InputList<Inputs.ServerDiskEditParameterNoteArgs>());
            set => _notes = value;
        }

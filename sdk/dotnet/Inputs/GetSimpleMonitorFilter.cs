...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetSimpleMonitorFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetSimpleMonitorFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetSimpleMonitorFilterConditionArgs>());

...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    {
        [Input("conditions")]
        private List<Inputs.GetVPCRouterFilterConditionArgs>? _conditions;
        ...
        /// </summary>
        public List<Inputs.GetVPCRouterFilterConditionArgs> Conditions
        {
            get => _conditions ?? (_conditions = new List<Inputs.GetVPCRouterFilterConditionArgs>());

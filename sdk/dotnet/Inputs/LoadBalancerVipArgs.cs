...
namespace Pulumi.Sakuracloud.Inputs
{
    ...
    public sealed class LoadBalancerVipArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("servers")]
        private InputList<Inputs.LoadBalancerVipServerArgs>? _servers;

        /// <summary>
        /// One or more `server` blocks as defined below.
        /// </summary>
        public InputList<Inputs.LoadBalancerVipServerArgs> Servers
        {
            get => _servers ?? (_servers = new InputList<Inputs.LoadBalancerVipServerArgs>());
            set => _servers = value;
        }

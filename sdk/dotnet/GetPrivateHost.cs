...
namespace Pulumi.Sakuracloud
{
    public static partial class Invokes
    {
        ...
        public static Task<GetPrivateHostResult> GetPrivateHost(GetPrivateHostArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPrivateHostResult>("sakuracloud:index/getPrivateHost:getPrivateHost", args, options.WithVersion());
    }

    public sealed class GetPrivateHostArgs : Pulumi.ResourceArgs
    {
        [Input("filters")]
        private InputList<Inputs.GetPrivateHostFiltersArgs>? _filters;

        /// <summary>
        /// The map of filter key and value.
        /// </summary>
        public InputList<Inputs.GetPrivateHostFiltersArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.GetPrivateHostFiltersArgs>());
            set => _filters = value;
        }
    ...
    public sealed class GetPrivateHostResult
    {
        ...
        public readonly ImmutableArray<Outputs.GetPrivateHostFiltersResult> Filters;
        /// <summary>
        ...
        private GetPrivateHostResult(
            ...
            int assignedMemory,
            string description,
            ImmutableArray<Outputs.GetPrivateHostFiltersResult> filters,
            string hostname,
            string name,
    ...
    public sealed class GetPrivateHostFiltersArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        /// The name of the resource.
        /// </summary>
        ...
        public GetPrivateHostFiltersArgs()
        {
        }
    }
    }
    ...
    [OutputType]
    public sealed class GetPrivateHostFiltersResult
    {
        /// <summary>
        /// The name of the resource.
        /// </summary>
        ...
        [OutputConstructor]
        private GetPrivateHostFiltersResult(
            string name,

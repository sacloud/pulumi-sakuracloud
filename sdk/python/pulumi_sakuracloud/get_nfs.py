...
class GetNFSResult:
    ...
    @property
    @pulumi.getter
    def filter(self) -> Optional['outputs.GetNFSFilterResult']:
    ...
    def network_interfaces(self) -> Sequence['outputs.GetNFSNetworkInterfaceResult']:
        """
...
def get_nfs(filter: Optional[pulumi.InputType['GetNFSFilterArgs']] = None,
    ...
    __ret__ = pulumi.runtime.invoke('sakuracloud:index/getNFS:getNFS', __args__, opts=opts, typ=GetNFSResult).value
